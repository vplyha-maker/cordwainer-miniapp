  ...
  return (
    ...
    >
      <header className="flex items-center gap-1 py-3">
        ...
        <h1
          className="flex-1 text-[17px] font-semibold tracking-tight truncate"
          style={{ color: 'var(--color-ink, #F5F1EA)' }}
        >
        ...
        <button
          ...
          className="h-9 px-3 rounded-full text-[12px] font-semibold flex-shrink-0"
          style={{
            border: '1px solid color-mix(in srgb, var(--color-accent, #D8A35C) 45%, transparent)',
      ...
      <div className="flex-1 flex flex-col gap-4 mt-1">
        ...
        >
          ...
          <div
            ...
            style={{ background: 'color-mix(in srgb, var(--color-bg, #1C1816) 70%, transparent)' }}
          >
            <button
              type="button"
              ...
              style={
                system === 'aniline'
                  ...
                  : {
                      color: 'color-mix(in srgb, var(--color-ink, #F5F1EA) 60%, transparent)',
                    }
              }
            >
              {isUk ? 'Анілін' : 'Анилин'}
          ...
          <p
            ...
            style={{ color: 'color-mix(in srgb, var(--color-ink, #F5F1EA) 45%, transparent)' }}
          >
            {systemHint}
          </p>
        </section>
          ...
          <div className="px-4 pb-4">
            {loading ? (
              <div
                ...
                style={{ color: 'color-mix(in srgb, var(--color-ink, #F5F1EA) 40%, transparent)' }}
              >
              ...
              <div className="flex flex-col gap-3">
                  ...
                  <div key={paint.id} className="flex items-center gap-2">
                    <div className="flex-1 min-w-0">
                      {pigments.length === 0 ? (
                        <div
                          ...
                          style={{ background: 'color-mix(in srgb, var(--color-ink, #F5F1EA) 10%, transparent)' }}
                        />
                      ) : (
                        <PigmentSelector
                          pigments={pigments}
                    ...
                    <input
                      ...
                      style={{
                        ...
                        color: 'var(--color-ink, #F5F1EA)',
                        // focus ring via box-shadow if needed
                      }}
                    />
                    <span
                    ...
                    <button
                      ...
                      style={{ color: 'color-mix(in srgb, var(--color-ink, #F5F1EA) 30%, transparent)' }}
                    >
                ...
                {system === 'acrylic' && totalAmount > 0 && (
                  <div
                    className="flex items-center gap-2 mt-1 pt-3 border-t border-dashed"
                    style={{ borderColor: 'color-mix(in srgb, var(--color-accent, #D8A35C) 30%, transparent)' }}
                  >
                    <div
                      className="flex-1 min-w-0 rounded-xl px-3 py-2.5"
                      style={{
                        background: 'color-mix(in srgb, var(--color-accent, #D8A35C) 15%, transparent)',
                        border: '1px solid color-mix(in srgb, var(--color-accent, #D8A35C) 35%, transparent)',
                      }}
                    >
                      <p
                        className="text-[13px] font-semibold"
                    ...
                    <div
                      className="w-[64px] flex-shrink-0 rounded-xl px-2 py-3 text-center font-semibold text-[15px]"
                      style={{
                    ...
                    <span
                      className="text-[12px] w-5 flex-shrink-0"
                      style={{ color: 'color-mix(in srgb, var(--color-accent, #D8A35C) 70%, transparent)' }}
                    >
                      мл
                    </span>
            ...
            <button
              ...
              style={{
                border: '1px dashed color-mix(in srgb, var(--color-accent, #D8A35C) 50%, transparent)',
                color: 'var(--color-accent, #D8A35C)',
              }}
            >
        ...
        >
          ...
          <div className="flex flex-col items-center">
                  ...
                  <button
                    ...
                    style={
                      anilineLayer === n
                        ...
                        : {
                            background: 'color-mix(in srgb, var(--color-ink, #F5F1EA) 8%, transparent)',
                            color: 'color-mix(in srgb, var(--color-ink, #F5F1EA) 60%, transparent)',
                          }
                    }
                  >
            ...
            <div
              ...
              className="relative w-36 h-36 rounded-2xl shadow-lg mb-3 overflow-hidden"
              style={{
            ...
            {targetHex && actualHex && (
              <div
                className="w-full mb-3 rounded-xl px-3 py-2.5 space-y-1.5"
                style={{
              ...
              >
                <div className="flex items-center justify-between text-[12px]">
                  <span style={{ color: 'color-mix(in srgb, var(--color-ink, #F5F1EA) 45%, transparent)' }}>
                    {isUk ? 'Ціль' : 'Цель'}
                  </span>
                  <span className="font-mono" style={{ color: 'color-mix(in srgb, var(--color-ink, #F5F1EA) 80%, transparent)' }}>
                    {targetHex}
                  </span>
                </div>
                <div className="flex items-center justify-between text-[12px]">
                  ...
                  <span className="font-mono" style={{ color: 'var(--color-ink, #F5F1EA)' }}>
                    {actualHex}
                  </span>
                </div>
                {liveDeltaE != null && (
                  <div
                    ...
                    style={{
                      borderTop: '1px solid color-mix(in srgb, var(--color-border, rgba(255,255,255,0.12)) 50%, transparent)',
                    }}
                  >
                    <button
                      type="button"
                    ...
                    >
                      ...
                      <span
                        ...
                        style={{
                          border: '1px solid color-mix(in srgb, var(--color-accent, #D8A35C) 60%, transparent)',
                        }}
                      >
                        i
                      </span>
                ...
                <button
                  ...
                  className="mt-1 w-full py-2 rounded-lg text-[12px] font-semibold disabled:opacity-40"
                  style={{
            ...
            {system === 'aniline' && mixedColor && (
              <p
                className="mb-3 text-[11px] text-center"
                style={{ color: 'color-mix(in srgb, var(--color-ink, #F5F1EA) 40%, transparent)' }}
              >
                {isUk
            ...
            <div className="w-full flex items-center gap-2">
              <input
                ...
                placeholder="#000000"
                className="flex-1 min-w-0 border-0 rounded-xl px-3 py-3 text-center font-mono tracking-wider focus:outline-none"
                style={{
                  fontSize: '16px',
                  background: 'color-mix(in srgb, var(--color-ink, #F5F1EA) 10%, transparent)',
                  color: 'var(--color-ink, #F5F1EA)',
                  boxShadow: hexError
                    ? '0 0 0 2px color-mix(in srgb, var(--color-danger, #f87171) 70%, transparent)'
                    : undefined,
                }}
            ...
            {hexError && (
              <p
                className="mt-1.5 text-[12px] text-center"
                style={{ color: 'var(--color-danger, #f87171)' }}
              >
                {isUk
            ...
            <p
              ...
              style={{ color: 'color-mix(in srgb, var(--color-ink, #F5F1EA) 35%, transparent)' }}
            >
              {hasColor
                ? isUk
        ...
        >
          <div className="flex items-center justify-between">
            <span
              className="text-[14px]"
              style={{ color: 'color-mix(in srgb, var(--color-ink, #F5F1EA) 50%, transparent)' }}
            >
          ...
          {system === 'acrylic' && binderMl > 0 && (
            <div className="flex items-center justify-between">
              <span
                className="text-[14px]"
                style={{ color: 'color-mix(in srgb, var(--color-accent, #D8A35C) 80%, transparent)' }}
              >
          ...
          >
            <span
              ...
              style={{ color: 'color-mix(in srgb, var(--color-ink, #F5F1EA) 70%, transparent)' }}
            >
      ...
      {/* Модалка ΔE */}
      {showDeltaInfo && (
        <div className="fixed inset-0 z-[70] flex items-end sm:items-center justify-center px-4 pb-safe"
          style={{ background: 'color-mix(in srgb, var(--color-bg, #1C1816) 60%, transparent)' }}
        >
          <div
            className="rounded-2xl p-5 w-full max-w-sm mb-4"
            style={{
          ...
          >
            <div className="flex items-center gap-2 mb-3">
              <span className="text-[16px] font-semibold" style={{ color: 'var(--color-accent, #D8A35C)' }}>
                ΔE
              </span>
              <span
                className="text-[13px]"
            ...
            <p
              ...
              style={{ color: 'color-mix(in srgb, var(--color-ink, #F5F1EA) 75%, transparent)' }}
            >
              {isUk
            ...
            <ul
              className="text-[12px] space-y-1.5 mb-4"
              style={{ color: 'color-mix(in srgb, var(--color-ink, #F5F1EA) 65%, transparent)' }}
            >
              <li>
                <span className="font-semibold" style={{ color: 'var(--color-success, #34d399)' }}>{'< 1'}</span>
                {' — '}
                {isUk ? 'різниці майже не видно' : 'разницы почти не видно'}
              </li>
              <li>
                <span className="font-semibold" style={{ color: 'var(--color-success, #34d399)' }}>1–2</span>
                {' — '}
                {isUk ? 'дуже добре для рецепту' : 'очень хорошо для рецепта'}
              </li>
              <li>
                <span className="font-semibold" style={{ color: 'var(--color-accent, #D8A35C)' }}>2–3.5</span>
                {' — '}
                {isUk ? 'прийнятно в майстерні' : 'приемлемо в мастерской'}
              </li>
              <li>
                <span className="font-semibold" style={{ color: 'var(--color-danger, #f87171)' }}>{'> 3.5'}</span>
                {' — '}
