          ...
          <div className="flex -space-x-3 shrink-0">
            ...
            {articleFavorites.length > 4 && (
              <button
                ...
                className="w-14 h-14 rounded-full border-2 border-[#151210] flex items-center justify-center bg-[#1D1815] relative text-[11px] font-bold text-[#D8A35C] active:scale-90 transition-transform"
                style={{ zIndex: 0 }}
              >
                +{articleFavorites.length - 4}
              </button>
